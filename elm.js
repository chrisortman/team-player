      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 _L.fromArray([]),
                 _L.fromArray([$Html.text(_v21._0)]))]),
                 A2($List.indexedMap,
                 F2(function (x,n) {
                    return A2($Html.td,
                    A2(cellAttrs,n,x),
...
Elm.PlayerList.make = function (_elm) {
   ...
   var tableStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                         ,_0: "border"
                                                         ,_1: "1px solid black"}]));
   var valueCell = function (x) {
      return A2($Html.td,
      _L.fromArray([]),
      _L.fromArray([$Html.text($Basics.toString(x))]));
   };
   ...
   model) {
      return function () {
         var prependEmptyCell = function (x) {
            return A2($List._op["::"],
            A2($Html.td,
            _L.fromArray([]),
            _L.fromArray([])),
         ...
         _L.fromArray([]),
         prependEmptyCell($List.map(valueCell)($List.map(playingCount(model))(_L.range(0,
         20)))))]);
         var buildPlayerRow = function (_v16) {
            return function () {
               switch (_v16.ctor)
               {case "_Tuple2":
   ...
   var PlayerListModel = F2(function (a,
   b) {
      return {_: {}
             ,nextID: b
             ,players: a};
